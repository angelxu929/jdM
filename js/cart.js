...
var deleteFuc = function(){
    ...
    winBox.getElementsByClassName('cancel')[0].onclick = function(){
        ...
        winBox.style.webkitTransform = 'translateY(0px)';
        winBox.style.transform = 'translateY(0px)';
        win.style.display = 'none';
        //winBox.className = 'jd_win_box';

        if(deleteList){
            up.style.webkitTransition = 'all 0.5s ease 0s';
            up.style.transition = 'all 0.5s ease 0s';
            up.style.transform = 'translateY(0px)  rotate(0deg)';
            up.style.webkitTransform = 'translateY(0px)  rotate(0deg)';
        }
        return false;
